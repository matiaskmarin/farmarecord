...
export default defineConfig(({ mode }) => {
    ...
    return {
      // GitHub Pages publica el sitio dentro de la ruta del repositorio.
      base: process.env.GITHUB_ACTIONS ? '/farmarecord/' : '/',
      define: {
      ...
      server: {
        // Permite el acceso mediante el enlace temporal de la demo.
